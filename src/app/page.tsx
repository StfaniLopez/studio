        ...
        <div className="mx-auto grid w-full max-w-6xl gap-6">
          ...
          <Tabs defaultValue="dashboard" className="grid w-full gap-4">
            <TabsList className="grid w-full grid-cols-2 h-auto md:grid-cols-4">
              ...
              <TabsTrigger value="path-generator" className="text-base">
                <Bot className="mr-2 h-4 w-4" />
                Optimal Path
              </TabsTrigger>
              <TabsTrigger value="elective-recommender" className="text-base">
                <Lightbulb className="mr-2 h-4 w-4" />
                Electives
              </TabsTrigger>
              <TabsTrigger value="graduation-predictor" className="text-base">
